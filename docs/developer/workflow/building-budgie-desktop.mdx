...
<CodeBlock language="bash">
  ...
  <br />
  sudo pacman -S --needed accountsservice budgie-session budgie-screensaver gnome-settings-daemon gobject-introspection ibus intltool libgee libpeas libwnck3 libxfce4windowing meson magpie-wm sassc vala zenity
</CodeBlock>
  </TabItem>
