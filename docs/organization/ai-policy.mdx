...
If you used an AI agent for planning or implementation, sharing that context as a **PR comment** can be valuable for reviewers and for the project's collective learning. However, AI planning documents should **not** be committed to the source repository. Sshare them as PR comments instead.
:::
