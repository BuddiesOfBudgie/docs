...
For other distributions than those listed above, you will need to follow the steps at [Building Budgie Desktop](/10.10/developer/workflow/building-budgie-desktop).
